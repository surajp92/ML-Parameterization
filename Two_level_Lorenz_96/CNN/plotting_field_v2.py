...
title = ['(a) True', '(b) CNN', '(c) DEnKF ($m=9$)', '(d) DEnKF ($m=18$)', '(e) Error (CNN)',
...
fig.tight_layout()
plt.show()  
fig.savefig('field_plot_cnn.pdf',bbox_inches='tight',dpi=300)
fig.savefig('field_plot_cnn.eps',bbox_inches='tight')
fig.savefig('field_plot_cnn.png',bbox_inches='tight',dpi=300)
